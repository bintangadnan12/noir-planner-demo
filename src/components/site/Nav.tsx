...
export function Nav() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("noir_theme");
  ...
  const toggleDark = () => {
    ...
    localStorage.setItem("noir_theme", next ? "dark" : "light");
  };
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-bg/95 backdrop-blur-md shadow-[0_1px_0_0_rgba(212,168,67,0.12)] py-3"
          : "bg-transparent py-5"
      }`}
    >
      <div className="container-x flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <a
            ...
            className={`inline-flex items-center gap-2 border px-5 py-2.5 text-xs tracking-[0.2em] uppercase transition-all hover:bg-gold hover:border-gold hover:text-bg ${
            ...
            >
              ...
              <nav className="flex flex-col p-6 gap-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex items-center justify-center bg-gold text-bg px-6 py-4 text-xs tracking-[0.2em] uppercase"
                >
                  Konsultasi Gratis
                </a>
              </nav>
